...
is that the main APs (AP, AP50, AP75) do not differ that much. And in fact,
they do not match with our hypothesis (b) as the Cascade R-CNN is the worst
model. We strongly believe that this is caused by small dataset size. The
...
\begin{table}[H]
	...
	\begin{tabular}{l|l|l|l|l|l|l}
		Model                  & AP    & AP$_{50}$ & AP$_{75}$ & AP$_l$ & AP$_m$ & AP$_s$ \\
		\hline
