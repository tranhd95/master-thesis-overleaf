...
correct, we need to define \bld{Intersection-over-Union (IoU)}. IoU is
...
accurate approximation is called \bld{training} (or we also say that the network
\bld{learns}). We describe this process in detail in
